...
2. After the entire is downloaded, prepare the csv files for training and validation using ``` csv_writer.py ``` as `train.csv` and `val.csv`. The format of the CSV file is:
